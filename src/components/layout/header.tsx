...
export function Header() {
  ...
  return (
    <header className="flex-shrink-0 bg-[rgba(6,13,7,0.90)] backdrop-blur-[26px] border-b border-grow-border rounded-b-3xl px-[18px] pt-4 pb-3 shadow-[0_20px_60px_rgba(0,0,0,0.65)] z-20">
      <div className="flex items-center justify-between">
        ...
        <Link
          href="/settings"
          className="w-9 h-9 rounded-[13px] border border-[rgba(41,181,84,0.12)] bg-[rgba(41,181,84,0.05)] flex items-center justify-center text-grow-muted hover:text-grow-primary transition-colors"
        >
